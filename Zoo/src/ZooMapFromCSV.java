...
public class ZooMapFromCSV extends JPanel implements ActionListener {
    ...
    private AnimalPopup animalPopup = null;  // ventana emergente

    public ZooMapFromCSV() {
        ...
        addMouseMotionListener(new MouseMotionAdapter() {
            ...
            public void mouseMoved(MouseEvent e) {
                if (selectedRow == -1) {
                    // No zoom, cerrar popup si existe
                    cerrarAnimalPopup();
                    return;
                }
                ...
                // Buscar animal bajo el mouse (en zoom, escala x2)
                ...
                if (animalEncontrado != null) {
                    // Mostrar ventana si no está ya visible para este animal
    ...
    private void cargarZonas(String archivo) {
        try (BufferedReader br = new BufferedReader(new FileReader(archivo))) {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                BufferedImage fondo = cargarImagen("C:\\Users\\PC\\IdeaProjects\\Zoo\\src\\imageszonas\\" + imagen);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            ZooMapFromCSV panel = new ZooMapFromCSV();
            ...
            frame.addWindowListener(new WindowAdapter() {
                ...
                public void windowClosed(WindowEvent e) {
                    // Abrir el ZooMapiMenu cuando se cierre el JFrame del mapa
                    SwingUtilities.invokeLater(() -> {
                        JFrame menu = new JFrame("ZooMapiMenu");
                        menu.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                        menu.setContentPane(new ZooMapiMenu());  // Asumiendo que tienes esta clase
                        menu.pack();
    ...
    // Ventana emergente sencilla para mostrar info del animal (tipo pokedex)
    static class AnimalPopup extends JDialog {
        private final Animal animal;

        public AnimalPopup(Animal animal) {
            super((Frame) null, false); // No modal
            this.animal = animal;
